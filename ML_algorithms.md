...
![x](https://latex.codecogs.com/png.latex?x "x") parameterized by ![\\theta](https://latex.codecogs.com/png.latex?%5Ctheta "\theta"): ![x;\\theta](https://latex.codecogs.com/png.latex?x%3B%5Ctheta "x;\theta")
